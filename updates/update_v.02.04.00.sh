...
echo "  [2/39] update_and_remove_all.sh"
...
echo "  [3/39] disable_auto_updates.sh"
...
echo "  [9/39] collect_mac_addresses.sh"
...
echo "  [12/39] remove_vpn_reset_network.sh"
...
echo "  [13/39] require_sudo_network.sh"
...
echo "  [16/39] collect_hardware_info.sh"
...
echo "  [17/39] collect_ram_info.sh"
...
echo "  [18/39] check_disk_space.sh"
...
echo "  [20/39] uninstall_firefox.sh"
...
echo "  [21/39] install_hostname_display.sh"
...
echo "  [24/39] install_simplenote.sh"
...
echo "  [25/39] install_redshift.sh"
...
echo "  [27/39] restrict_chromium_cpu.sh"
...
echo "  [28/39] manage_wallpapers.sh"
...
echo "  [29/39] run_remote_command.sh"
...
echo "  [33/39] install_connectivity_watchdog.sh"
...
echo "  [34/39] remove_connectivity_watchdog.sh"
...
echo "  [35/39] check_watchdog_status.sh"
...
echo "  [37/39] change_password.sh"

# ============================================================================
# 38. configure_watchdog_hosts.sh (no credentials needed)
# ============================================================================
...
echo "  [38/39] configure_watchdog_hosts.sh"
