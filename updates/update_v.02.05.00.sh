...
echo "  [2/40] update_and_remove_all.sh"
...
echo "  [3/40] disable_auto_updates.sh"
...
echo "  [9/40] collect_mac_addresses.sh"
...
echo "  [12/40] remove_vpn_reset_network.sh"
...
echo "  [13/40] require_sudo_network.sh"
...
echo "  [16/40] collect_hardware_info.sh"
...
echo "  [17/40] collect_ram_info.sh"
...
echo "  [18/40] check_disk_space.sh"
...
echo "  [20/40] uninstall_firefox.sh"
...
echo "  [21/40] install_hostname_display.sh"
...
echo "  [24/40] install_simplenote.sh"
...
echo "  [25/40] install_redshift.sh"
...
echo "  [27/40] restrict_chromium_cpu.sh"
...
echo "  [28/40] manage_wallpapers.sh"
...
echo "  [29/40] run_remote_command.sh"
...
echo "  [33/40] install_connectivity_watchdog.sh"
...
echo "  [34/40] remove_connectivity_watchdog.sh"
...
echo "  [35/40] check_watchdog_status.sh"
...
echo "  [39/40] configure_watchdog_hosts.sh"
