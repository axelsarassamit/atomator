...
echo "  [2/41] update_and_remove_all.sh"
...
echo "  [3/41] disable_auto_updates.sh"
...
echo "  [9/41] collect_mac_addresses.sh"
...
echo "  [12/41] remove_vpn_reset_network.sh"
...
echo "  [13/41] require_sudo_network.sh"
...
echo "  [16/41] collect_hardware_info.sh"
...
echo "  [17/41] collect_ram_info.sh"
...
echo "  [18/41] check_disk_space.sh"
...
echo "  [20/41] uninstall_firefox.sh"
...
echo "  [21/41] install_hostname_display.sh"

# ============================================================================
# 22. fix_hostname_display.sh
# ============================================================================
cat > fix_hostname_display.sh << 'EOF'
#!/bin/bash
set +e
source ./credentials.conf 2>/dev/null || { echo "ERROR: credentials.conf not found!"; exit 1; }
...
echo "  [22/41] fix_hostname_display.sh"
...
echo "  [24/41] remove_wine.sh"

# ============================================================================
# 24. install_simplenote.sh
# ============================================================================
cat > install_simplenote.sh << 'EOF'
#!/bin/bash
set +e
source ./credentials.conf 2>/dev/null || { echo "ERROR: credentials.conf not found!"; exit 1; }
...
echo "  [25/41] install_simplenote.sh"

# ============================================================================
# 25. install_redshift.sh
# ============================================================================
cat > install_redshift.sh << 'EOF'
#!/bin/bash
set +e
source ./credentials.conf 2>/dev/null || { echo "ERROR: credentials.conf not found!"; exit 1; }
...
echo "  [26/41] install_redshift.sh"
...
echo "  [28/41] restrict_chromium_cpu.sh"
...
echo "  [29/41] manage_wallpapers.sh"
...
echo "  [30/41] run_remote_command.sh"
...
echo "  [34/41] install_connectivity_watchdog.sh"
...
echo "  [35/41] remove_connectivity_watchdog.sh"
...
echo "  [36/41] check_watchdog_status.sh"
...
echo "  [38/41] change_password.sh"

# ============================================================================
# 38. fix_slow_sudo.sh
# ============================================================================
cat > fix_slow_sudo.sh << 'EOF'
#!/bin/bash
set +e
source ./credentials.conf 2>/dev/null || { echo "ERROR: credentials.conf not found!"; exit 1; }
echo "=== Fix Slow Sudo ==="
...
echo "  [40/41] configure_watchdog_hosts.sh"
